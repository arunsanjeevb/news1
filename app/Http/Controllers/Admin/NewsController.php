...
//        $data['speciality_id']  = $request->speciality_id;
        ...
        //special stories start
        if($request->special_stories){
            $data['special_stories']         = 1 ;
        }else{
            $data['special_stories']         = 0 ;
        }
        //special stories end

        if($request->live_news){
            $data['live_news'] = 1 ;
        }else{
            $data['live_news'] = 0 ;
        }
        // Hide commends
        if($request->hide_commends){
            $data['hide_commends']         = 1 ;
        }else{
