...
(function($) {
    ...
    function manuBar() {
        ...
        let manuBarStor = $(".maan-manu-bar").html();
      	...
      	let manuShow = (`<div class="maan-hide-manu"><div class="maan-top-bar">${topManuStor}</div></div><div class="maan-manu-bar">${manuBarStor} </div><div class="maan-mid-bar">${MidBarStor}</div>`);
	...
	function passShowHide(){
		let showPass = document.querySelector('.toggle-pass');
		showPass.addEventListener('click', function() {
			showPass.classList.toggle("passwordShow");
