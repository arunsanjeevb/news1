...
@section('meta_content')
    ...
    <style>
        .live .card.maan-default-post .maan-post-img{
            height: 23ch;
        }
        .live h4 a {
            display: -webkit-box;
        ...
        .city .politics-news-big-items .card.maan-default-post .maan-post-img img{
...
@section('main_content')
            ...
            <div class="row">
                @foreach($latestnews as $lastnews)
                    <div class="@if($loop->first) col-lg-5 topnews-big-card  @else col-lg-3 @endif">
                        ...
                        <div class="maan-card-body">
                            <div class="maan-text">
                                <h4 style="font-size: 35px; line-height: 1.2; margin-top: 15px;">
                                    <a href="
                                    @if($lastnews->news_categoryslug)
                                    @if(Route::has(strtolower($lastnews->news_categoryslug)))
                                    {{ route( strtolower($lastnews->news_categoryslug).'.details',['id'=>$lastnews->id,'slug'=>\Illuminate\Support\Str::slug($lastnews->title)]) }}
                                ...
                                <p style="line-height: 1.5; font-size: 16px; font-weight: 0 !important; "> {{ $lastnews->summary}}</p>
                                <ul>
                                    @if($loop->first)
                                        @if($lastnews->special_stories)
                                            <li class="author">
                ...
                <div class="col-lg-7 live">
                    <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card maan-default-post">
                                    ...
                                    <div class="card-body maan-card-body">
                                        <div class="maan-text">
                                            <h4 style="font-weight: 100 !important;"><a class="fir" href="@if($lastnewsentertainment->news_categoryslug) {{ route(strtolower($lastnewsentertainment->news_categoryslug).'.details',['id'=>$lastnewsentertainment->id,'slug'=>\Illuminate\Support\Str::slug($lastnewsentertainment->title)]) }} @endif">{{ $lastnewsentertainment->title }}</a></h4>
                                            <ul>
                                                <li>
                                                        <span class="maan-icon">
                        ...
                        @foreach($liveNews as $lastnewsentertainment)
                            <div class="col-lg-6">
                                <div class="maan-news-list home-top">
                                    <ul class="web-only">
                                        <li>
            ...
            <div class="container-fluid">
                <div class="row maan-slide">
                    @foreach($blogcategories as $blogcategory)
                        <div class="col-lg-2">
                            <div class="card maan-card-img">
                                <a class="topcategories-thumb" href="{{ route('stories.details',['id'=>$blogcategory->id,'slug'=>\Illuminate\Support\Str::slug($blogcategory->title)]) }}">
                                    @if ($blogcategory->image)
                                        @php
                                            $images = json_decode($blogcategory->image);
                                        @endphp
                                        @if($images!='')
                                            @foreach ($images as $image)
                                                @if (File::exists($image))

                                                    <img src="{{ asset($image) }}" alt="{{$blogcategory->title}}">
                                                @endif
                                            @endforeach
                                        @endif
                                    @endif
                                    ...
                                    <div class="card-body maan-card-body">
                                        <span class="maan-tag-red">{{ $blogcategory->name  }}</span>
                                        <div class="maan-text">
                                            <h4><a href="{{ route('stories.details',['id'=>$blogcategory->id,'slug'=>\Illuminate\Support\Str::slug($blogcategory->title)]) }}">
                                                    {{ $blogcategory->title }}
                                                </a></h4>
                                        </div>
                                    </div>
    ...
    <!-- Maan Don't Miss End -->
    <section class="maan-top-categories-section maan-slide" style="display: none;">
        <div class="container">
            <div class="maan-title ">
                <div class="maan-title-text">
                    <h2>{{ __('Special Stories') }}</h2>
                </div>
            </div>
            <div class="row">
                @foreach($blogcategories as $blogcategory)
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        <div class="card maan-card-img">
                            {{--                            <a class="topcategories-thumb" href="@if(Route::has(strtolower($blogcategory->slug))){{ route(strtolower($newscategory->slug),$newscategory->name) }}@endif">--}}
                            <a class="topcategories-thumb" href="{{ route('stories.details',['id'=>$blogcategory->id,'slug'=>\Illuminate\Support\Str::slug($blogcategory->title)]) }}">
                                {{--                            <a class="topcategories-thumb" href="">--}}
                                @if ($blogcategory->image)
                                    @php
                                        $images = json_decode($blogcategory->image);
                                    @endphp
                            ...
                            <div class="card-body maan-card-body">
                                <a href="{{ route('stories.details',['id'=>$blogcategory->id,'slug'=>\Illuminate\Support\Str::slug($blogcategory->title)]) }}">
                                    {{--                                <a href=" @if(Route::has($blogcategory->id))){{ route(strtolower($blogcategory->id),$newscategory->name) }}@endif">--}}
                                    {{--                                <a class="" href="">--}}
    ...
    <!-- Maan City News Start -->
    <section class="maan-technology-news-section maan-politics-section city">
        <div class="container">
            ...
            <div class="row">
                @foreach($latestnewscity as $lastnewspolitics)
    ...
    <section class="maan-technology-news-section maan-politics-section" >
        <div class="container">
            ...
            <div class="row">
                @foreach($latestnewsnational as $lastnewspolitics)
                    <div class=" col-lg-3 politics-news-big-items">
                        <div class="card maan-default-post">
                            <div class="maan-post-img">
                                @if($lastnewspolitics->image)
    ...
    <section class="maan-technology-news-section maan-politics-section" >
        <div class="container">
            ...
            <div class="row">
                @foreach($latestnewsworlds as $lastnewspolitics)
    ...
    <section class="maan-technology-news-section maan-politics-section" style="padding: 0px;">
        <div class="container">
            <div class="maan-title justify-content-center">
                <div class="maan-title-text">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="maan-left-content">
                        <div class="row">
                                        ...
                                        <div class="card maan-default-post">
                                            ...
                                            <div class="card-body maan-card-body">
                                                <div class="maan-text">
                                                    <h4><a href="@if($lastnewsentertainment->news_categoryslug) {{ route(strtolower($lastnewsentertainment->news_categoryslug).'.details',['id'=>$lastnewsentertainment->id,'slug'=>\Illuminate\Support\Str::slug($lastnewsentertainment->title)]) }} @endif">{{ $lastnewsentertainment->title }}</a></h4>
                                                    <ul>
                                                        @if($lastnewsentertainment->special_stories)
                                                            <li>
                                                        <span class="maan-icon">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
                                                            <g   transform="translate(-24.165)">
                            ...
                            <?php
//                                echo '<pre>';
//                                print_r($latestnewsentertainment);
//                                exit;
                            ?>
                            @foreach($latestnewsentertainment as $lastnewsentertainment)
                                <div class="col-lg-6">
                                    <div class="maan-news-list home-only">
                                        <ul>
                                            <li>
                                                <!-- web -->
                                                <div class="maan-list-img web-only">
                                                    @if($lastnewsentertainment->image)
                                                        @php
                                                            $images = json_decode($lastnewsentertainment->image)
                                                        @endphp
                                                ...
                                                <div class="maan-list-text web-only">
                                                    <h4><a href="@if($lastnewsentertainment->news_categoryslug) {{ route(strtolower($lastnewsentertainment->news_categoryslug).'.details',['id'=>$lastnewsentertainment->id,'slug'=>\Illuminate\Support\Str::slug($lastnewsentertainment->title)]) }} @endif">{{ $lastnewsentertainment->title }}</a></h4>
                                                    <ul>
                                                        <!-- <li>
                                                            <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                ...
                                                <!-- mobile -->
                                                <div class="maan-list-text mobile-only">
                                                    <h4><a href="@if($lastnewsentertainment->news_categoryslug) {{ route(strtolower($lastnewsentertainment->news_categoryslug).'.details',['id'=>$lastnewsentertainment->id,'slug'=>\Illuminate\Support\Str::slug($lastnewsentertainment->title)]) }} @endif">{{ $lastnewsentertainment->title }}</a></h4>
                                                    <ul>
                                                        <!-- <li>
                                                            <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
                                                ...
                                                <div class="maan-list-img mobile-only">
                                                    @if($lastnewsentertainment->image)
                                                        @php
                                                            $images = json_decode($lastnewsentertainment->image)
                                                        @endphp
...
@endif
                                ...
                                <div class="maan-text">
                                    ...
                                    <ul>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
                                            ...
                                            <span class="maan-item-text" style="display: none"><a href="#">{{ $lastnewstehnology->reporter_name }}</a></span>
                                        </li>
                                        <!-- <li>
                                            <span class="maan-icon"><svg viewBox="0 0 512 512"><path d="M347.216,301.211l-71.387-53.54V138.609c0-10.966-8.864-19.83-19.83-19.83c-10.966,0-19.83,8.864-19.83,19.83v118.978 c0,6.246,2.935,12.136,7.932,15.864l79.318,59.489c3.569,2.677,7.734,3.966,11.878,3.966c6.048,0,11.997-2.717,15.884-7.952 C357.766,320.208,355.981,307.775,347.216,301.211z"></path><path d="M256,0C114.833,0,0,114.833,0,256s114.833,256,256,256s256-114.833,256-256S397.167,0,256,0z M256,472.341 c-119.275,0-216.341-97.066-216.341-216.341S136.725,39.659,256,39.659c119.295,0,216.341,97.066,216.341,216.341 S375.275,472.341,256,472.341z"></path></svg></span>
    ...
    <!-- Maan Don't Miss Start -->
    <section class="maan-don-t-miss-section" style="display: none;">
        <div class="container">
            <div class="maan-title">
                                    ...
                                    @if($loop->iteration==1)
                                        ...
                                        <div class="card-body maan-card-body">
                                            <div class="maan-text">
                                                ...
                                                <ul>
                                                    @if($lastnewssports->special_stories)
                                                        <li>
                                                <span class="maan-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
                                                <g   transform="translate(-24.165)">
                        ...
                        <div class="card maan-default-post">
                            ...
                            <div class="card-body maan-card-body">
                                <div class="maan-text">
                                    ...
                                    <ul>
                                        @if($lastnewslifestyle->special_stories)
                                            <li>
                                        <span class="maan-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
                                        <g  transform="translate(-24.165)">
    ...
    <script>
        ...
        pdfjsLib.getDocument(pdfPath).promise.then(function(pdf) {
            ...
            // Create a thumbnail for each page of the PDF
