                                    ...
                                    <div class="card maan-default-post">
                                        ...
                                        <div class="card-body maan-card-body">
                                            <div class="maan-text">
                                                ...
                                                <ul>
                                                    <li>
                                                        <p class="left-p">{{ $allnewsvalue->summary }}</p>
                                                    </li>
                        ...
                        <!-- <div class="maan-slide">
                            @foreach($allnews as $allnewsvalue )
                                <div class="card maan-default-post">
                                    ...
                                    <div class="card-body maan-card-body">
                                        <div class="maan-text">
                                            <h2><a href="{{ route(strtolower($allnewsvalue->news_categoryslug).'.details',['id'=>$allnewsvalue->id,'slug'=>\Illuminate\Support\Str::slug($allnewsvalue->title)]) }}">{{ $allnewsvalue->title }}</a></h2>
                                            <ul>
                                                <li>
                                                    <p>{{ $allnewsvalue->summary }}</p>
                                                </li>
                                                <li style="display: none;">
                                                <span class="maan-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="12.007" height="13.414" viewBox="0 0 12.007 13.414">
