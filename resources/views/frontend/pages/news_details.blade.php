            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="social-media blog-details-social">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.instagram.com/url={{url()->current()}}" target="_blank"><i class="fab fa-instagram"></i></a>
                                </li>
                                <li>
                                    <a href="https://www.whatsapp.com//url={{url()->current()}}" target="_blank"><i class="fab fa-whatsapp"></i></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    @if(1==2)
                        ...
                        <div class="maan-title" style="display: block">
                            <div class="maan-title-text">
                                <h2>{{ __('Gallery') }}</h2>
                            </div>
                        </div>
                        <div class="maan-widgets" style="display: block">
