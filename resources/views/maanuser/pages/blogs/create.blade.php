...
@section('main_content')
                        ...
                        <div class="card">
                            <div class="card-header col-12 row ">
                                ...
                                <div class="col-2 ">
                                    ...
                                    <a href="{{ route('maanuser.blog') }}" class="btn btn-sm btn-outline-secondary float-right mb-3"><span class="fas fa-arrow-left"></span>
                                        {{ __('Back') }}
                                    </a>
                            ...
                            <div class="card-body">
                                <!-- form start -->
                                <form method="POST" action="{{ route('maanuser.blog') }}"  enctype="multipart/form-data">
                                    @csrf
                            ...
                            {{$message}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2bs4" name="category_id" id="blogcategory_id1">
    ...
    <script>
        ...
        var config = {
            routes: {
                blogcategory: "{{ URL::to('maanuser/blog/create') }}"
            }
        };
