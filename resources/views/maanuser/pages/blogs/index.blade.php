...
{{--                                    @if(Auth::user()->permissions->contains('slug','create'))--}}
                                    <a href="{{ route('maanuser.blog.create') }}" class="btn btn-sm btn-success float-right mb-3"><span class="fas fa-plus"></span>
                                        {{ __('Add') }}
                                    </a>
{{--                                    @endif--}}
                                </div>
...
{{--                                                        @if(Auth::user()->permissions->contains('slug','edit'))--}}
                                                        <a href="{{ route('maanuser.blog.edit',$blog->id) }}"  class="edit-item" id="edit-item_{{$blog->id}}" >
...
{{--                                                        @if(Auth::user()->permissions->contains('slug','delete'))--}}
                                                        ...
                                                        <form class="archiveItem" action="{{ route('maanuser.blog.destroy',$blog->id) }}" method="post" >
                                                            @csrf
                                                            @method('delete')
