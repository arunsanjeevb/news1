...
use App\Http\Controllers\Frontend\LivenewsController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
...
//blog start - special stories
Route::get('/special-stories',[\App\Http\Controllers\Frontend\StoriesController::class,'maanNewsStories']);
Route::get('/special-stories/details/{id}/{slug?}',[\App\Http\Controllers\Frontend\StoriesController::class,'maanNewsDetails'])->name('stories.details');
//special stories end
